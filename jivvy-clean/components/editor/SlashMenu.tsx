...
import { Type, CheckSquare, Heading1, Heading2, List, Image, Quote, BookOpen, FileText } from 'lucide-react';

export type SlashMenuOption = {
    label: string;
    type: 'text' | 'task' | 'heading1' | 'heading2' | 'bullet' | 'image' | 'pdf_highlight' | 'page_break' | 'lecture_container' | 'subpage';
...
const SLASH_MENU_OPTIONS: SlashMenuOption[] = [
    ...
    { label: 'Subpage', type: 'subpage', icon: FileText, description: 'Link to a new nested page' },
];
