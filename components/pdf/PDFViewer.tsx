...
import { Loader2, Download, FileText, ExternalLink, RotateCw } from "lucide-react";
...
export function PDFViewer({ url, className }: PDFViewerProps) {
    ...
    return (
        <div className={cn("flex flex-col h-full bg-zinc-900/50 rounded-lg overflow-hidden border border-white/5 relative", className)}>
            {/* Controls */}
